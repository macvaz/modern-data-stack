...
HMS v4.0.0-beta-1 starts perfectly but some incompatibility isues arise when using trino (trino uses [version 3.1](https://github.com/trinodb/trino/blob/39af728fa5e474d5537ede364f7599c941541f2f/pom.xml#L1393) of the Metastore Thift API). The practical results integrating latest versions of Trino and HMS can be checked at [hive4 branch](https://github.com/macvaz/modern_data_stack/tree/hive4)

The current code uses an old (v3.0.0) and unoffical docker container of HMS coming from https://github.com/bitsondatadev/hive-metastore
